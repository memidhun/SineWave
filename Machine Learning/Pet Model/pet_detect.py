...
# Load the model
model = load_model(r"C:\Users\Midhun Mathew\Desktop\Test\Machine Learning\Pet Model\pet_model.h5", compile=False)

# Load the labels
class_names = open(r"C:\Users\Midhun Mathew\Desktop\Test\Machine Learning\Pet Model\labels.txt", "r").readlines()
